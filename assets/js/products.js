...
// ==========================================
const IMG = {
  fiberglassShell: (typeof SERVICE_IMAGES !== 'undefined' && SERVICE_IMAGES.fiberglassShell) || 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 400" fill="none"><rect width="500" height="400" fill="%23e8f1f5"/><rect x="50" y="60" width="400" height="280" rx="30" fill="%230ea5e9" stroke="%23ffffff" stroke-width="10"/><path d="M 100 90 L 160 90 M 100 120 L 140 120 M 100 150 L 120 150" stroke="%23ffffff" stroke-width="6" stroke-linecap="round"/><path d="M 60 200 C 150 220 350 220 440 200" stroke="rgba(255,255,255,0.4)" stroke-width="4" fill="none"/></svg>',
  concreteShell: (typeof SERVICE_IMAGES !== 'undefined' && SERVICE_IMAGES.concreteShell) || 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 400" fill="none"><rect width="500" height="400" fill="%23dbe7ee"/><path d="M 80 120 C 100 60, 400 60, 420 150 C 440 240, 260 340, 180 320 C 100 300, 60 180, 80 120 Z" fill="%230ea5e9" stroke="%23ffffff" stroke-width="10"/><path d="M 110 140 L 160 110" stroke="%23ffffff" stroke-width="6" stroke-linecap="round"/><path d="M 120 160 L 170 130" stroke="%23ffffff" stroke-width="6" stroke-linecap="round"/></svg>',
  plungeShell: (typeof SERVICE_IMAGES !== 'undefined' && SERVICE_IMAGES.plungeShell) || 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 400" fill="none"><rect width="500" height="400" fill="%23e8f1f5"/><rect x="100" y="60" width="300" height="280" rx="20" fill="%230082c8" stroke="%23ffffff" stroke-width="10"/><rect x="130" y="90" width="240" height="70" rx="10" fill="rgba(255,255,255,0.25)"/></svg>',
  soilExc: (typeof SERVICE_IMAGES !== 'undefined' && SERVICE_IMAGES.soilExc) || 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 400" fill="none"><rect width="500" height="400" fill="%23e8f1f5"/><path d="M 50 300 L 450 300 L 410 150 L 90 150 Z" fill="%238c6239" opacity="0.7"/><path d="M 150 250 L 350 250" stroke="%23ffffff" stroke-width="6" stroke-linecap="round"/></svg>',
  rockExc: (typeof SERVICE_IMAGES !== 'undefined' && SERVICE_IMAGES.rockExc) || 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 400" fill="none"><rect width="500" height="400" fill="%23dbe7ee"/><path d="M 50 320 L 450 320 L 410 180 L 90 180 Z" fill="%23545b62"/><path d="M 120 280 L 160 220 L 220 260 L 280 200 L 340 280" stroke="%23ffc107" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/></svg>',
  slopeExc: (typeof SERVICE_IMAGES !== 'undefined' && SERVICE_IMAGES.slopeExc) || 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 400" fill="none"><rect width="500" height="400" fill="%23e8f1f5"/><path d="M 50 120 L 450 280 L 450 350 L 50 350 Z" fill="%237c8f7b" opacity="0.8"/><rect x="280" y="220" width="120" height="100" fill="%23b2bec3" stroke="%2395a5a6" stroke-width="4"/></svg>',
  narrowExc: (typeof SERVICE_IMAGES !== 'undefined' && SERVICE_IMAGES.narrowExc) || 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 400" fill="none"><rect width="500" height="400" fill="%23e8f1f5"/><path d="M 180 80 L 320 80 L 320 320 L 180 320 Z" fill="%23b2bec3" opacity="0.5"/><rect x="210" y="120" width="80" height="160" rx="10" fill="%23ffc107" stroke="%23e0a800" stroke-width="4"/></svg>',
  sandFilter: (typeof SERVICE_IMAGES !== 'undefined' && SERVICE_IMAGES.sandFilter) || 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 400" fill="none"><rect width="500" height="400" fill="%23e8f1f5"/><circle cx="250" cy="220" r="110" fill="%237f8c8d" stroke="%2334495e" stroke-width="8"/><rect x="230" y="60" width="40" height="60" fill="%232c3e50"/><path d="M 210 110 L 290 110" stroke="%2334495e" stroke-width="6"/></svg>',
  ecoPump: (typeof SERVICE_IMAGES !== 'undefined' && SERVICE_IMAGES.ecoPump) || 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 400" fill="none"><rect width="500" height="400" fill="%23dbe7ee"/><rect x="120" y="160" width="160" height="140" rx="10" fill="%232d3436"/><rect x="280" y="190" width="110" height="100" rx="50" fill="%2314b8a6"/><path d="M 200 160 L 200 100 H 250" stroke="%232d3436" stroke-width="12" stroke-linecap="round"/></svg>',
  roboCleaner: (typeof SERVICE_IMAGES !== 'undefined' && SERVICE_IMAGES.roboCleaner) || 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 400" fill="none"><rect width="500" height="400" fill="%23e8f1f5"/><rect x="140" y="140" width="220" height="140" rx="30" fill="%230ea5e9" stroke="%230082c8" stroke-width="8"/><circle cx="180" cy="280" r="30" fill="%232d3436"/><circle cx="320" cy="280" r="30" fill="%232d3436"/><path d="M 170 140 L 250 80 L 330 140" stroke="%23ffffff" stroke-width="8" fill="none" stroke-linecap="round"/></svg>',
  basicSeason: (typeof SERVICE_IMAGES !== 'undefined' && SERVICE_IMAGES.basicSeason) || 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 400" fill="none"><rect width="500" height="400" fill="%23e8f1f5"/><rect x="150" y="80" width="200" height="260" rx="10" fill="%23ffffff" stroke="%23b2bec3" stroke-width="6"/><path d="M 180 140 L 220 180 L 320 100" stroke="%2314b8a6" stroke-width="8" stroke-linecap="round" fill="none"/><path d="M 180 230 L 220 270 L 320 190" stroke="%2314b8a6" stroke-width="8" stroke-linecap="round" fill="none"/></svg>',
  weeklyCare: (typeof SERVICE_IMAGES !== 'undefined' && SERVICE_IMAGES.weeklyCare) || 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 400" fill="none"><rect width="500" height="400" fill="%23dbe7ee"/><rect x="150" y="80" width="200" height="260" rx="10" fill="%23ffffff" stroke="%23b2bec3" stroke-width="6"/><path d="M 190 130 H 310 M 190 180 H 310 M 190 230 H 310 M 190 280 H 260" stroke="%230ea5e9" stroke-width="6" stroke-linecap="round"/><path d="M 130 60 H 370" stroke="%230ea5e9" stroke-width="8" stroke-linecap="round"/></svg>'
};
